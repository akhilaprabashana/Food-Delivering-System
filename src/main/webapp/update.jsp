...
<html>
    ...
    <body> 
        ...
        <form action="update" method="post">
            ...
            <input type="text" id="col" name="cid" value="<%= id%>" readonly><br><br>
            <label for="name" id="t1">Name</label><br>
            <input type="text" id="col" name="name" value="<%= name%>"><br><br>
            <label for="password" id="t1">Password</label><br>
            <input type="password" id="col" name="password" value="<%= password%>"><br><br>
            <label for="phone" id="t1">Phone</label><br>
            <input type="text" id="col" name="phone" value="<%= phone%>"><br><br>
            <label for="email" id="t1">Email</label><br>
            <input type="email" id="col" name="email" value="<%= email%>"><br><br>

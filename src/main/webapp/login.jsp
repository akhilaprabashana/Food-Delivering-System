        ...
        <header class="header"><!-- header section start  -->
            ...
            <center>
                ...
                <form action="login" method="post">
                        <h3 id="heading1">Login for more taste</h3>
                        <label for="name" id="t1">Name</label><br>
                        <input type="text" name="name" id="col"><br><br>
                        <label for="password" id="t1">Password</label><br>
                        <input type="password" name="pass" id="col"><br><br>
                        <input type="submit" name="Login" id="btn1">
                    </form>
                </div>
                </center>
                <br><br><br><br><br><br><br>

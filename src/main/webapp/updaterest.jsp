...
<html>
    ...
    <form method="post" action="urest">
        ...
        <input type="text" name="rest" value="<%= name%>" id="col"><br><br>
        <label for="rate" id="t1">Ratings</label><br>
        <input type="text" name="rate" value="<%= rate%>" id="col"><br><br>
        <label for="loc" id="t1">Location</label><br>
        <input type="text" name="loc" value="<%= loca%>" id="col"><br><br>
        <label for="contact" id="t1">Contact</label><br>
        <input type="text" name="contact" value="<%= cont%>" id="col"><br><br>
